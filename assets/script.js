        ...
        squares[i].onclick = function() {           
             //se il quadrato sotto di me e' preso posso posizionare il mio gettone sopra quel quadrato(contenente l'altro gettone)
                if(squares[index + 7].classList.contains('taken')) {
                    ...
                    // Simuliamo la gravita' rendendo impossibile occupare spazio con il gettone se sotto non ne abbiamo un altro
    ...
    function checkBoard() {
        ...
        if(square1.classList.contains('player-one') &&
           ...
           square4.classList.contains('player-one')) {
               // se sono uguali, player one diventa il vincitore
               result.innerHTML = 'Player One wins!'
           }
           // adesso facciamo lo stesso per il player 2
